...
const RewardsSection = () => {
  ...
  return (
    <section className="relative w-full bg-gray-100 h-[70vh] md:h-screen py-8 md:py-16 px-4 text-center overflow-hidden">
      ...
      {/* Text and Buttons - Mobile Version */}
      ...
      {/* Text and Buttons - Desktop Version */}
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-8 hidden md:flex h-full items-center justify-center">
        <div className={`transform transition-all duration-1000 ${imageLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white">REWARDING STAY</h2>
          <h3 className="text-xl md:text-2xl font-semibold mb-6 text-white">GET EXCLUSIVE DISCOUNTS ON MEALS</h3>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mt-8">
            <a
              href="/blogs"
              className="group bg-transparent border-2 border-white text-white px-8 py-3 rounded-full hover:bg-white hover:text-black transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-white focus:ring-opacity-50"
              aria-label="Explore rewards program"
            >
              <span className="flex items-center justify-center">
                Explore
            ...
            <a
              href="/contact"
              className="group bg-yellow-500 text-white px-8 py-3 rounded-full border-2 border-yellow-500 hover:bg-white hover:text-yellow-500 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-yellow-500 focus:ring-opacity-50 shadow-lg"
              aria-label="Join the rewards program now"
            >
              <span className="flex items-center justify-center">
                Join Now
